...
const ALLOWED_INVOKE = new Set([
  ...
  'communication:enqueueBatch',
  'communication:drainQueue',
  'communication:init',
  'whatsapp:embedShow',
  'whatsapp:embedHide',
  'whatsapp:embedBounds',
  'whatsapp:openChat',
  'whatsapp:openSendSlot',
...
const cuppingApi = {
  ...
  communication: {
    ...
    enqueueBatch: (payload) => invoke('communication:enqueueBatch', payload || {}),
    drainQueue: (config) => invoke('communication:drainQueue', config || {}),
  ...
  whatsapp: {
    ...
    openSendSlot: (url) => invoke('whatsapp:openSendSlot', url || ''),
